...
/**
 * Amazon_FWSInbound_Model_FulfillmentItem
 * 
 * Properties:
 * <ul>
 * 
 ...
 * </ul>
 */ 
class Amazon_FWSInbound_Model_FulfillmentItem extends Amazon_FWSInbound_Model
{


    /**
     * Construct new Amazon_FWSInbound_Model_FulfillmentItem
     * 
    ...
    public function __construct($data = null)
    {
        ...
        'IsActive' => array('FieldValue' => null, 'FieldType' => 'bool'),
        );
     ...
     * @return Amazon_FWSInbound_Model_FulfillmentItem instance
     */
    ...
    {
        return $this->_fields['IsActive']['FieldValue'];
    }
    ...
    {
        $this->_fields['IsActive']['FieldValue'] = $value;
        return $this;
    }

    /**
     * Sets the value of the IsActive and returns this instance
     * 
     * @param bool $value IsActive
     * @return Amazon_FWSInbound_Model_FulfillmentItem instance
     */
    ...
    /**
     * Checks if IsActive is set
     * 
     * @return bool true if IsActive  is set
     */
    public function isSetIsActive()
    {
        return !is_null($this->_fields['IsActive']['FieldValue']);
    }
