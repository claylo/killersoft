...
/**
 * Amazon_FWSInbound_Model_GetServiceStatusResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetServiceStatusResult: Amazon_FWSInbound_Model_GetServiceStatusResult</li>
 * <li>ResponseMetadata: Amazon_FWSInbound_Model_ResponseMetadata</li>
 *
 * </ul>
 */ 
class Amazon_FWSInbound_Model_GetServiceStatusResponse extends Amazon_FWSInbound_Model
{


    /**
     * Construct new Amazon_FWSInbound_Model_GetServiceStatusResponse
     * 
    ...
    {
        $this->_fields = array (
        'GetServiceStatusResult' => array('FieldValue' => null, 'FieldType' => 'Amazon_FWSInbound_Model_GetServiceStatusResult'),
    ...
    /**
     * Construct Amazon_FWSInbound_Model_GetServiceStatusResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon_FWSInbound_Model_GetServiceStatusResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Amazon_FWSInbound_Model_GetServiceStatusResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct Amazon_FWSInbound_Model_GetServiceStatusResponse from provided XML. 
     ...
     * @return Amazon_FWSInbound_Model_GetServiceStatusResponse instance
     */
    ...
    {
        $xml = "";
        $xml .= "<GetServiceStatusResponse xmlns=\"http://fba-inbound.amazonaws.com/doc/2007-05-10/\">";
