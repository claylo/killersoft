...
/**
 * Get Fulfillment Identifier  Sample
 */
 ...
 * sample for Get Fulfillment Identifier Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_FWSInbound_Model_GetFulfillmentIdentifier 
 // object or array of parameters
 // invokeGetFulfillmentIdentifier($service, $request);

                            
/**
  * Get Fulfillment Identifier Action Sample
  ...
  * @param mixed $request Amazon_FWSInbound_Model_GetFulfillmentIdentifier or array of parameters
  */
  function invokeGetFulfillmentIdentifier(Amazon_FWSInbound_Interface $service, $request) 
  {
      try {
              $response = $service->getFulfillmentIdentifier($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        GetFulfillmentIdentifierResponse\n");
                if ($response->isSetGetFulfillmentIdentifierResult()) { 
                    echo("            GetFulfillmentIdentifierResult\n");
                    $getFulfillmentIdentifierResult = $response->getGetFulfillmentIdentifierResult();
                    $fulfillmentItemList = $getFulfillmentIdentifierResult->getFulfillmentItem();
