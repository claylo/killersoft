...
/**
 * Get Fulfillment Item By FNSKU  Sample
 */
 ...
 * sample for Get Fulfillment Item By FNSKU Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_FWSInbound_Model_GetFulfillmentItemByFNSKU 
 // object or array of parameters
 // invokeGetFulfillmentItemByFNSKU($service, $request);

                                                
/**
  * Get Fulfillment Item By FNSKU Action Sample
  ...
  * @param mixed $request Amazon_FWSInbound_Model_GetFulfillmentItemByFNSKU or array of parameters
  */
  function invokeGetFulfillmentItemByFNSKU(Amazon_FWSInbound_Interface $service, $request) 
  {
      try {
              $response = $service->getFulfillmentItemByFNSKU($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        GetFulfillmentItemByFNSKUResponse\n");
                if ($response->isSetGetFulfillmentItemByFNSKUResult()) { 
                    echo("            GetFulfillmentItemByFNSKUResult\n");
                    $getFulfillmentItemByFNSKUResult = $response->getGetFulfillmentItemByFNSKUResult();
                    $fulfillmentItemList = $getFulfillmentItemByFNSKUResult->getFulfillmentItem();
