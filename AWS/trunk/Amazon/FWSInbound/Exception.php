...
/**
 * FWS Inbound  Exception provides details of errors 
 * returned by FWS Inbound  service
 *
 */
class Amazon_FWSInbound_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_FWSInbound_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_FWSInbound_Exception) {
