...
/**
 * Elastic Map Reduce  Exception provides details of errors 
 * returned by Elastic Map Reduce  service
 *
 */
class Amazon_ElasticMapReduce_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_ElasticMapReduce_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_ElasticMapReduce_Exception) {
