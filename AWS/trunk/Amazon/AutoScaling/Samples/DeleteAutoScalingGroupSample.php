...
/**
 * Delete Auto Scaling Group  Sample
 */
 ...
 * sample for Delete Auto Scaling Group Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_AutoScaling_Model_DeleteAutoScalingGroupRequest
 // object or array of parameters
 // invokeDeleteAutoScalingGroup($service, $request);

                                                                
/**
  * Delete Auto Scaling Group Action Sample
  
  * @param Amazon_AutoScaling_Interface $service instance of Amazon_AutoScaling_Interface
  * @param mixed $request Amazon_AutoScaling_Model_DeleteAutoScalingGroup or array of parameters
  */
  function invokeDeleteAutoScalingGroup(Amazon_AutoScaling_Interface $service, $request) 
  {
      try {
              $response = $service->deleteAutoScalingGroup($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        DeleteAutoScalingGroupResponse\n");
