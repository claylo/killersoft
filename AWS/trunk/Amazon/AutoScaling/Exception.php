...
/**
 * Auto Scaling  Exception provides details of errors 
 * returned by Auto Scaling  service
 *
 */
class Amazon_AutoScaling_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_AutoScaling_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_AutoScaling_Exception) {
