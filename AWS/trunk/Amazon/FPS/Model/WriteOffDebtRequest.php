...
/**
 * Amazon_FPS_Model_WriteOffDebtRequest
 * 
 * Properties:
 * <ul>
 * 
 * <li>CreditInstrumentId: string</li>
 * <li>AdjustmentAmount: Amazon_FPS_Model_Amount</li>
 * <li>CallerReference: string</li>
 * <li>CallerDescription: string</li>
 *
 * </ul>
 */ 
class Amazon_FPS_Model_WriteOffDebtRequest extends Amazon_FPS_Model
{


    /**
     * Construct new Amazon_FPS_Model_WriteOffDebtRequest
     * 
    ...
    public function __construct($data = null)
    {
        ...
        'AdjustmentAmount' => array('FieldValue' => null, 'FieldType' => 'Amazon_FPS_Model_Amount'),
     ...
     * @return Amazon_FPS_Model_WriteOffDebtRequest instance
     */
    ...
    /**
     * Gets the value of the AdjustmentAmount.
     * 
    ...
    /**
     * Sets the value of the AdjustmentAmount.
     * 
    ...
    /**
     * Sets the value of the AdjustmentAmount  and returns this instance
     * 
     * @param Amount $value AdjustmentAmount
     * @return Amazon_FPS_Model_WriteOffDebtRequest instance
     */
    ...
    /**
     * Checks if AdjustmentAmount  is set
     * 
     * @return bool true if AdjustmentAmount property is set
     */
