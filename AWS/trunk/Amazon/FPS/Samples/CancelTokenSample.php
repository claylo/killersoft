 ...
 * sample for Cancel Token Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_FPS_Model_CancelTokenRequest
 // object or array of parameters
 // invokeCancelToken($service, $request);

                        
/**
  * Cancel Token Action Sample
  * 
  ...
  * @param mixed $request Amazon_FPS_Model_CancelToken or array of parameters
  */
  function invokeCancelToken(Amazon_FPS_Interface $service, $request) 
  {
      try {
              $response = $service->cancelToken($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        CancelTokenResponse\n");
