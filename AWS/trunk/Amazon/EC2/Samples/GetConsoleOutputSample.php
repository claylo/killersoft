 ...
 * sample for Get Console Output Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_GetConsoleOutputRequest
 // object or array of parameters
 // invokeGetConsoleOutput($service, $request);

                                                                                                                                                    
/**
  * Get Console Output Action Sample
  ...
  * @param mixed $request Amazon_EC2_Model_GetConsoleOutput or array of parameters
  */
  function invokeGetConsoleOutput(Amazon_EC2_Interface $service, $request) 
  {
      try {
              $response = $service->getConsoleOutput($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        GetConsoleOutputResponse\n");
                ...
                if ($response->isSetGetConsoleOutputResult()) { 
                    ...
                    if ($getConsoleOutputResult->isSetConsoleOutput()) { 
                        ...
                        {
                            echo("                    InstanceId\n");
                            echo("                        " . $consoleOutput->getInstanceId() . "\n");
                        }
                        if ($consoleOutput->isSetTimestamp()) 
                        {
                            echo("                    Timestamp\n");
                            echo("                        " . $consoleOutput->getTimestamp() . "\n");
                        }
                        if ($consoleOutput->isSetOutput()) 
                        {
                            echo("                    Output\n");
                            echo("                        " . $consoleOutput->getOutput() . "\n");
                        }
                    } 
                } 
