...
/**
 * FWS Outbound  Exception provides details of errors 
 * returned by FWS Outbound  service
 *
 */
class Amazon_FWSOutbound_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_FWSOutbound_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_FWSOutbound_Exception) {
