 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_FWSOutbound_Model_ListAllFulfillmentOrders 
...
/**
  ...
  * @param mixed $request Amazon_FWSOutbound_Model_ListAllFulfillmentOrders or array of parameters
  */
  function invokeListAllFulfillmentOrders(Amazon_FWSOutbound_Interface $service, $request) 
  {
      try {
              $response = $service->listAllFulfillmentOrders($request);
                ...
                if ($response->isSetListAllFulfillmentOrdersResult()) { 
                    ...
                    if ($listAllFulfillmentOrdersResult->isSetHasNext()) 
                    {
                        echo("                HasNext\n");
                        echo("                    " . $listAllFulfillmentOrdersResult->getHasNext() . "\n");
                    }
                    $fulfillmentOrderList = $listAllFulfillmentOrdersResult->getFulfillmentOrder();
