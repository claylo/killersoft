 ...
 * 
 */
class  Amazon_FWSOutbound_Mock implements Amazon_FWSOutbound_Interface
{
    // Public API ------------------------------------------------------------//
    ...
    public function getServiceStatus($request) 
    {
        ...
        return Amazon_FWSOutbound_Model_GetServiceStatusResponse::fromXML($this->_invoke('GetServiceStatus'));
    }
    ...
    public function createFulfillmentOrder($request) 
    {
        ...
        return Amazon_FWSOutbound_Model_CreateFulfillmentOrderResponse::fromXML($this->_invoke('CreateFulfillmentOrder'));
    }
    ...
    public function cancelFulfillmentOrder($request) 
    {
        ...
        return Amazon_FWSOutbound_Model_CancelFulfillmentOrderResponse::fromXML($this->_invoke('CancelFulfillmentOrder'));
    }
    ...
    public function getFulfillmentOrder($request) 
    {
        ...
        return Amazon_FWSOutbound_Model_GetFulfillmentOrderResponse::fromXML($this->_invoke('GetFulfillmentOrder'));
    }
    ...
    public function listAllFulfillmentOrders($request) 
    {
        ...
        return Amazon_FWSOutbound_Model_ListAllFulfillmentOrdersResponse::fromXML($this->_invoke('ListAllFulfillmentOrders'));
    }
    ...
    public function listAllFulfillmentOrdersByNextToken($request) 
    {
        ...
        return Amazon_FWSOutbound_Model_ListAllFulfillmentOrdersByNextTokenResponse::fromXML($this->_invoke('ListAllFulfillmentOrdersByNextToken'));
    }
    ...
    {
        return $xml = file_get_contents('Amazon/FWSOutbound/Mock/' . $actionName . 'Response.xml', /** search include path */ TRUE);
    }
}