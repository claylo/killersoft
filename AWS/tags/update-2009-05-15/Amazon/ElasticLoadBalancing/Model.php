...
/**
 * Amazon_ElasticLoadBalancing_Model - base class for all model classes
 */ 
abstract class Amazon_ElasticLoadBalancing_Model
{
    ...
    {
        return preg_match('/^Amazon_ElasticLoadBalancing_Model_/', $fieldType);
    }
