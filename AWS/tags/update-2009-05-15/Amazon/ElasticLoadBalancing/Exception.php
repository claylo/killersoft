...
/**
 * Elastic Load Balancing  Exception provides details of errors 
 * returned by Elastic Load Balancing  service
 *
 */
class Amazon_ElasticLoadBalancing_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_ElasticLoadBalancing_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_ElasticLoadBalancing_Exception) {
