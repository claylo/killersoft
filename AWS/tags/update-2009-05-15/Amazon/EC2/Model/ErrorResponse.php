...
/**
 * Amazon_EC2_Model_ErrorResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>Error: Amazon_EC2_Model_Error</li>
 * <li>RequestId: string</li>
 *
 * </ul>
 */ 
class Amazon_EC2_Model_ErrorResponse extends Amazon_EC2_Model
{


    /**
     * Construct new Amazon_EC2_Model_ErrorResponse
     * 
    ...
    {
        $this->_fields = array (
        'Error' => array('FieldValue' => array(), 'FieldType' => array('Amazon_EC2_Model_Error')),
    ...
    /**
     * Construct Amazon_EC2_Model_ErrorResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon_EC2_Model_ErrorResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Amazon_EC2_Model_ErrorResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct Amazon_EC2_Model_ErrorResponse from provided XML. 
     ...
     * @return Amazon_EC2_Model_ErrorResponse  instance
     */
    ...
    {
        $xml = "";
        $xml .= "<ErrorResponse xmlns=\"http://ec2.amazonaws.com/doc/2009-04-04/\">";
