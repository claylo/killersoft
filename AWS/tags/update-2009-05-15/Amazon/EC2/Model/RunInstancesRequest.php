...
class Amazon_EC2_Model_RunInstancesRequest extends Amazon_EC2_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'Monitoring' => array('FieldValue' => null, 'FieldType' => 'bool'),
        );
     ...
     * 
     * @return bool true if Monitoring  is set
     */
