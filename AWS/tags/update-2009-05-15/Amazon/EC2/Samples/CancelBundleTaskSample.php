 ...
 * sample for Cancel Bundle Task Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_CancelBundleTaskRequest
 // object or array of parameters
 // invokeCancelBundleTask($service, $request);

                                            
/**
  * Cancel Bundle Task Action Sample
  ...
  * @param mixed $request Amazon_EC2_Model_CancelBundleTask or array of parameters
  */
  function invokeCancelBundleTask(Amazon_EC2_Interface $service, $request) 
  {
      try {
              $response = $service->cancelBundleTask($request);
                ...
                if ($response->isSetCancelBundleTaskResult()) { 
                    echo("            CancelBundleTaskResult\n");
                    $cancelBundleTaskResult = $response->getCancelBundleTaskResult();
                    $bundleTaskList = $cancelBundleTaskResult->getBundleTask();
