 ...
 * sample for Disassociate Address Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_DisassociateAddressRequest
 // object or array of parameters
 // invokeDisassociateAddress($service, $request);

                                                                                                                                                
/**
  * Disassociate Address Action Sample
  ...
  * @param mixed $request Amazon_EC2_Model_DisassociateAddress or array of parameters
  */
  function invokeDisassociateAddress(Amazon_EC2_Interface $service, $request) 
  {
      try {
              $response = $service->disassociateAddress($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        DisassociateAddressResponse\n");
