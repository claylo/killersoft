 ...
 * sample for Delete Volume Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_EC2_Model_DeleteVolumeRequest
 // object or array of parameters
 // invokeDeleteVolume($service, $request);

                                                                                
/**
  * Delete Volume Action Sample
  ...
  * @param mixed $request Amazon_EC2_Model_DeleteVolume or array of parameters
  */
  function invokeDeleteVolume(Amazon_EC2_Interface $service, $request) 
  {
      try {
