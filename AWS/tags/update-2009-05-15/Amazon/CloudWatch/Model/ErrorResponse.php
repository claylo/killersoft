...
/**
 * Amazon_CloudWatch_Model_ErrorResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>Error: Amazon_CloudWatch_Model_Error</li>
 * <li>RequestId: string</li>
 *
 * </ul>
 */ 
class Amazon_CloudWatch_Model_ErrorResponse extends Amazon_CloudWatch_Model
{


    /**
     * Construct new Amazon_CloudWatch_Model_ErrorResponse
     * 
    ...
    {
        $this->_fields = array (
        'Error' => array('FieldValue' => array(), 'FieldType' => array('Amazon_CloudWatch_Model_Error')),
    ...
    /**
     * Construct Amazon_CloudWatch_Model_ErrorResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon_CloudWatch_Model_ErrorResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Amazon_CloudWatch_Model_ErrorResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct Amazon_CloudWatch_Model_ErrorResponse from provided XML. 
     ...
     * @return Amazon_CloudWatch_Model_ErrorResponse  instance
     */
