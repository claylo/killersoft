...
/**
 * Cloud Watch  Exception provides details of errors 
 * returned by Cloud Watch  service
 *
 */
class Amazon_CloudWatch_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_CloudWatch_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_CloudWatch_Exception) {
