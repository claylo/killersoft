...
/**
 * Amazon_ElasticMapReduce_Model - base class for all model classes
 */ 
abstract class Amazon_ElasticMapReduce_Model
{
    ...
    {
        return preg_match('/^Amazon_ElasticMapReduce_Model_/', $fieldType);
    }
