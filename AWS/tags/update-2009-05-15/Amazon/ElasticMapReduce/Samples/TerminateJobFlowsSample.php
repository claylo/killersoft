 ...
 * sample for Terminate Job Flows Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_ElasticMapReduce_Model_TerminateJobFlowsRequest
 // object or array of parameters
 // invokeTerminateJobFlows($service, $request);

                    
/**
  * Terminate Job Flows Action Sample
  
  * @param Amazon_ElasticMapReduce_Interface $service instance of Amazon_ElasticMapReduce_Interface
  * @param mixed $request Amazon_ElasticMapReduce_Model_TerminateJobFlows or array of parameters
  */
  function invokeTerminateJobFlows(Amazon_ElasticMapReduce_Interface $service, $request) 
  {
      try {
              $response = $service->terminateJobFlows($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        TerminateJobFlowsResponse\n");
