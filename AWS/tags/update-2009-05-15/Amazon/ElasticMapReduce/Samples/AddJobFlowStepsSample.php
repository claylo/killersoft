 ...
 * sample for Add Job Flow Steps Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_ElasticMapReduce_Model_AddJobFlowStepsRequest
 // object or array of parameters
 // invokeAddJobFlowSteps($service, $request);

                
/**
  * Add Job Flow Steps Action Sample
  
  * @param Amazon_ElasticMapReduce_Interface $service instance of Amazon_ElasticMapReduce_Interface
  * @param mixed $request Amazon_ElasticMapReduce_Model_AddJobFlowSteps or array of parameters
  */
  function invokeAddJobFlowSteps(Amazon_ElasticMapReduce_Interface $service, $request) 
  {
      try {
              $response = $service->addJobFlowSteps($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        AddJobFlowStepsResponse\n");
