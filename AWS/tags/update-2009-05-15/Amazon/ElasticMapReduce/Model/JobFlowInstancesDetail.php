...
/**
 * Amazon_ElasticMapReduce_Model_JobFlowInstancesDetail
 * 
 * Properties:
 * <ul>
 * 
 * <li>MasterInstanceType: string</li>
 * <li>MasterPublicDnsName: string</li>
 * <li>MasterInstanceId: string</li>
 ...
 * </ul>
 */ 
class Amazon_ElasticMapReduce_Model_JobFlowInstancesDetail extends Amazon_ElasticMapReduce_Model
{


    /**
     * Construct new Amazon_ElasticMapReduce_Model_JobFlowInstancesDetail
     * 
    ...
    public function __construct($data = null)
    {
        ...
        'MasterPublicDnsName' => array('FieldValue' => null, 'FieldType' => 'string'),
        'MasterInstanceId' => array('FieldValue' => null, 'FieldType' => 'string'),
     ...
     * @return Amazon_ElasticMapReduce_Model_JobFlowInstancesDetail instance
     */
     ...
     * 
     * @return string MasterPublicDnsName
     */
    public function getMasterPublicDnsName() 
    {
        return $this->_fields['MasterPublicDnsName']['FieldValue'];
    }

    /**
     * Sets the value of the MasterPublicDnsName property.
     * 
     * @param string MasterPublicDnsName
     * @return this instance
     */
    public function setMasterPublicDnsName($value) 
    {
        $this->_fields['MasterPublicDnsName']['FieldValue'] = $value;
        return $this;
    }

    /**
     * Sets the value of the MasterPublicDnsName and returns this instance
     * 
     * @param string $value MasterPublicDnsName
     * @return Amazon_ElasticMapReduce_Model_JobFlowInstancesDetail instance
     */
    public function withMasterPublicDnsName($value)
    {
        $this->setMasterPublicDnsName($value);
        return $this;
    }


    /**
     * Checks if MasterPublicDnsName is set
     * 
     * @return bool true if MasterPublicDnsName  is set
     */
    public function isSetMasterPublicDnsName()
    {
        return !is_null($this->_fields['MasterPublicDnsName']['FieldValue']);
    }

    /**
     * Gets the value of the MasterInstanceId property.
     * 
     * @return string MasterInstanceId
     */
    public function getMasterInstanceId() 
    {
        return $this->_fields['MasterInstanceId']['FieldValue'];
    }
     ...
     * @return this instance
     */
    public function setMasterInstanceId($value) 
    {
        $this->_fields['MasterInstanceId']['FieldValue'] = $value;
        return $this;
    }

    /**
     * Sets the value of the MasterInstanceId and returns this instance
     * 
     * @param string $value MasterInstanceId
     * @return Amazon_ElasticMapReduce_Model_JobFlowInstancesDetail instance
     */
    public function withMasterInstanceId($value)
    {
        $this->setMasterInstanceId($value);
        return $this;
    }


    /**
     * Checks if MasterInstanceId is set
     * 
     * @return bool true if MasterInstanceId  is set
     */
    public function isSetMasterInstanceId()
    {
        return !is_null($this->_fields['MasterInstanceId']['FieldValue']);
    }
