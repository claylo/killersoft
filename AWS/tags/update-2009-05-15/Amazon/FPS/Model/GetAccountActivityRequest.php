...
class Amazon_FPS_Model_GetAccountActivityRequest extends Amazon_FPS_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'SortOrderByDate' => array('FieldValue' => null, 'FieldType' => 'string'),
        'FPSOperation' => array('FieldValue' => null, 'FieldType' => 'string'),
        'PaymentMethod' => array('FieldValue' => null, 'FieldType' => 'string'),
        'Role' => array('FieldValue' => array(), 'FieldType' => array('string')),
     ...
     * 
     * @param string $value SortOrderByDate
     * @return Amazon_FPS_Model_GetAccountActivityRequest instance
     */
     ...
     * 
     * @param string or an array of string Role
     * @return this instance
     */
     ...
     * 
     * @param string  $stringArgs one or more Role
     * @return Amazon_FPS_Model_GetAccountActivityRequest  instance
     */
