 ...
 * sample for Delete Trigger Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_AutoScaling_Model_DeleteTriggerRequest
 // object or array of parameters
 // invokeDeleteTrigger($service, $request);

                                
/**
  * Delete Trigger Action Sample
  
  * @param Amazon_AutoScaling_Interface $service instance of Amazon_AutoScaling_Interface
  * @param mixed $request Amazon_AutoScaling_Model_DeleteTrigger or array of parameters
  */
  function invokeDeleteTrigger(Amazon_AutoScaling_Interface $service, $request) 
  {
      try {
              $response = $service->deleteTrigger($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        DeleteTriggerResponse\n");
