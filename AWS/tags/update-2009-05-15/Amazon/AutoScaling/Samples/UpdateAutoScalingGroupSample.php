...
/**
 * Update Auto Scaling Group  Sample
 */
 ...
 * sample for Update Auto Scaling Group Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_AutoScaling_Model_UpdateAutoScalingGroupRequest
 // object or array of parameters
 // invokeUpdateAutoScalingGroup($service, $request);

                        
/**
  * Update Auto Scaling Group Action Sample
  
  * @param Amazon_AutoScaling_Interface $service instance of Amazon_AutoScaling_Interface
  * @param mixed $request Amazon_AutoScaling_Model_UpdateAutoScalingGroup or array of parameters
  */
  function invokeUpdateAutoScalingGroup(Amazon_AutoScaling_Interface $service, $request) 
  {
      try {
              $response = $service->updateAutoScalingGroup($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        UpdateAutoScalingGroupResponse\n");
