...
/**
 * Create Auto Scaling Group  Sample
 */
 ...
 * sample for Create Auto Scaling Group Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as Amazon_AutoScaling_Model_CreateAutoScalingGroupRequest
 // object or array of parameters
 // invokeCreateAutoScalingGroup($service, $request);

                            
/**
  * Create Auto Scaling Group Action Sample
  
  * @param Amazon_AutoScaling_Interface $service instance of Amazon_AutoScaling_Interface
  * @param mixed $request Amazon_AutoScaling_Model_CreateAutoScalingGroup or array of parameters
  */
  function invokeCreateAutoScalingGroup(Amazon_AutoScaling_Interface $service, $request) 
  {
      try {
              $response = $service->createAutoScalingGroup($request);
              
                echo ("Service Response\n");
                echo ("=============================================================================\n");

                echo("        CreateAutoScalingGroupResponse\n");
